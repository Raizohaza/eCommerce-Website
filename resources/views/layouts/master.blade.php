...
<head>
  ...
  <link href="{{asset('/frontend/assets/css/now-ui-dashboard.css?v=1.3.0')}}" rel="stylesheet" />
...
<li class="nav-item dropdown">
 ...
 <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
  ...
  <script src="{{asset('/frontend/assets/js/now-ui-dashboard.min.js?v=1.3.0')}}" type="text/javascript"></script>
